### OJS / OMP / OPS Plugins in Plugin Gallery
Plugin|OJS|OPS|OMP|Summary
|---|---|---|---|---
|[Shibboleth](https://github.com/pkp/shibboleth)|:ok:|:ok:|:ok:|This plugin adds Shibboleth support.
...
|[Notificação de atualização de plugins](https://github.com/lepidus/pluginUpdateNotification)|:ok:|:ok:|:ok:|Este plugin gera uma notificação sempre que há uma atualização disponível de um plugin da galeria
...
|[Form Honeypot](https://github.com/ulsdevteam/pkp-formHoneypot)|:ok:|:ok:|:ok:|This plugin adds a honeypot to user registration.
...
|[Twitter Block Plugin](https://github.com/RBoelter/ojs3-twitter-sidebar)|:ok:|:ok:|:ok:|This plugin adds a block to display a Twitter feed in the sidebar.
|[Announcements Block](https://github.com/RBoelter/announcementsBlock)|:ok:|:ok:|:ok:|This plugin adds a block to display announcements in the sidebar.
...
|[OpenID Authentication Plugin](https://github.com/leibniz-psychology/openid)|:ok:|:ok:|:ok:|This plugin allows users to register and login with an OpenID Connect provider such as Keycloak, Google, Orchid, Microsoft and Apple
...
|[Histórico dos autores](https://github.com/lepidus/authorsHistory)|:ok:|:ok:|-|Este plugin adiciona uma aba na visualização da submissão, onde todos as submissões de cada contribuidor são listadas.
|[ORCiD Profile](https://github.com/pkp/orcidProfile)|:ok:|:ok:|-|ORCiD integration for users and authors
|[Paperbuzz](https://github.com/pkp/paperbuzz)|:ok:|:ok:|-|Display free altmetrics based on open data from Paperbuzz.
|[Relatório de Submissões SciELO](https://github.com/lepidus/scieloSubmissionsReport)|:ok:|:ok:|-|Este plugin gera um relatório CSV com informação das submissões que é normalmente requisitada pela SciELO.
...
|[Matomo](https://github.com/pkp/piwik)|:ok:|-|:ok:|Permits usage statistics tracking using Matomo (formerly Piwik).
...
|[EPUB Viewer](https://github.com/EKT/epubJsViewer-ojs)|:ok:|-|-|This plugin uses the (<a href="https://github.com/futurepress/epub.js" target="_blank">epub.js library</a>) to embed EPUB files on the articles and issues galley view pages.
...
|[Texture plugin](https://github.com/pkp/texture)|:ok:|-|-|Integrates the Substance Texture JATS XML Editor with OJS.
...
|[ReviewerCredits Plugin](https://gitlab.com/reviewercredits/reviewercredits-ojs-plugin)|:ok:|-|-|This plugin enable the integration with ReviewerCredits (www.reviewercredits.com).
...
|[Archivematica Export](https://github.com/escire/ArchivematicaExportPlugin)|:ok:|-|-|Exports articles or issues to Archivematica for its preservation.
|[PKP|PN (PKP Preservation Network) Plugin](https://github.com/pkp/pln)|:ok:|-|-|Supports preservation of published journal content in the PKP Preservation Network.
|[Scopus/Crossref Citations Plugin](https://github.com/RBoelter/citations)|:ok:|-|-|Shows the total number of citations and a "cited by" article list from Scopus and/or Crossref.
|[Portico Plugin](https://github.com/pkp/portico)|:ok:|-|-|Supports export of published content to Portico.
|[Research Organization Registry(ROR) Plugin](https://github.com/withanage/ror/)|:ok:|-|-|OJS 3 Plugin for adding Organization names for author affiliations provided by ROR.org
|[DOI to mEDRA xml export and registration plugin](https://github.com/pkp/medra/)|:ok:|-|-|Allows DOI export in ONIX4DOI format and the registration with mEDRA.
|[Browse By Section Plugin](https://github.com/pkp/browseBySection)|:ok:|-|-|A plugin which allows visitors to browse published articles by section.
|[Lucene/Solr Plugin](https://github.com/ojsde/lucene)|:ok:|-|-|Solr/Lucene integration for OJS
...
|[Datacite](https://github.com/withanage/datacite)|-|-|:ok:|This plugin allows DOI registration via Datacite
